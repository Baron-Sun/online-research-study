export const INFORMED_CONSENT_TEXT = `Principal Investigator: William J. Brady
...
• We expect that you will be in this research study for about 9–11 minutes.
...
We do not foresee any risk in participating in this study. If you choose to participate, the effects should be comparable to those you would experience from completing a task and answering questions for a few minutes using a mouse and keyboard (or using your smartphone). It is possible that you might be uncomfortable answering certain questions; if that happens, you may simply leave them blank. A possible risk for any research is that confidentiality could be compromised—that people outside the study might get hold of confidential study information. We will do everything we can to minimize this risk, as described in more detail later in this form.
...
You will receive $1.50 for your participation in this 9–11-minute study.
...
If you do not wish to participate in this study, please select "I Disagree" or close this browser window.`;
